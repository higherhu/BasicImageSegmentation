...
public:
	...
	GBlock(int size, void (*err_function)(char *) = NULL) { first = last = NULL; block_size = size; error_function = err_function; }

	/* Destructor. Deallocates all items added so far */
	~GBlock() { while (first) { block *next = first -> next; delete first; first = next; } }
